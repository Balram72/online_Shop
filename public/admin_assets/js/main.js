                    ...
                    datasets: [
                        {
                            ...
                            data: [
                                78, 81, 80, 65, 58, 75, 60, 75, 65, 60, 60, 75,
                            ],
                    ...
                    datasets: [
                        {
                            label: "My First dataset",
                            data: [
                                78, 81, 80, 64, 65, 80, 70, 75, 67, 85, 66, 68,
                            ],
                            borderColor: "transparent",
                            borderWidth: "0",
                            backgroundColor: "#ccc",
...
function update_payment_status(id) {
    ...
    if (check == true) {
        window.location.href =
            "/admin/order/update_payment_status/" + payment_status + "/" + id;
    }
}
...
function update_order_status(id) {
    ...
    if (check == true) {
        window.location.href =
            "/admin/order/update_order_status/" + order_status + "/" + id;
    }
}
