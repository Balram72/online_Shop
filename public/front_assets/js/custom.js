...
function add_to_cart(id, size_str_id, color_str_id) {
    ...
    if (size_id == "" && size_id != "no") {
        jQuery("#add_to_cart_msg").html(
            '<div class="alert alert-danger fade in alert-dismissible" style="margin-top:10px"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a> Plese Select size</div>'
        );
    } else if (color_id == "" && color_id != "no") {
        jQuery("#add_to_cart_msg").html(
            '<br><div class="alert alert-danger fade in alert-dismissible" style="margin-top:10px"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a> Plese Select Color</div>'
        );
    } else {
...
jQuery(document).ready(function () {
    jQuery("#frmRegistration").submit(function (e) {
        ...
        jQuery("#thank_you_reg_msg").html("Please Wait.....");
        jQuery.ajax({
            ...
            success: function (result) {
                ...
                if (result.status == "success") {
                    ...
                    jQuery("#thank_you_reg_msg").html(result.msg);
                }
            },
        });
    });
