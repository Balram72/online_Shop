            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{{url('/')}}">
                  ...
                  <p>Fashion<strong>Mart</strong> <span>Your Shopping Partner</span></p>
                </a>
              </div>
               <!-- cart box -->
               @php
              ...
              <div class="aa-cartbox">
                ...
                @if($totalCartItem>0 )
                  <ul>
                    ...
                    @endphp
                    <li>
                      <a class="aa-cartbox-img" href="{{ url('./product/' . $cartItem->slug) }}">
                        <img src="{{asset('storage/media/'.$cartItem->image)}}" alt="img"></a>
        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <div id="popup_login">
            ...
            <form class="aa-login-form" id="frmlogin">
              ...
              <input type="email" name="str_login_email" placeholder="Email" value="{{$login_email}}" required>
  
              <label for="">Password<span>*</span></label>
              <input type="password" name="str_login_password" placeholder="Password" value="{{$login_pwd}}" required>
          ...
          <div id="popup_forgot" style="display: none;">
             <h4>Forgot Password</h4>
              <form class="aa-login-form" id="frmforgot">
                <label for="">Email address<span>*</span></label>
                <input type="email" name="str_forgot_email" placeholder="Email"required>
